...
export class InicioComponent implements OnInit {
  ...
  public mas_productos_vendidos : Array<any> =[]
  ...
  ngOnInit(): void {
    ...
    this._guestService.listar_productos_nuevos_publico().subscribe(response=>{
    ...
    this._guestService.listar_productos_mas_vendido_publico().subscribe(response=>{
      this.mas_productos_vendidos = response.data
